...
% SBS 203/204
\datedsubsection{\textbf{Teaching Fellow, Social and Behavioral Sciences 203/204}}{2022}
...
% \begin{enumerate}[leftmargin = 2em, labelsep=1.2em]
%     \item \parskip 1pt \noindent Zahid, N., Pulvera, R., Madsen, K.A., \textbf{Lee, M. M.}, Ibarra-Castro, A., Falbe, J. Racial, Ethnic, and Socioeconomic Disparities in Outdoor Branded Advertising in San Francisco and Oakland, California. \textit{Under Review} (2021).
%     \item \parskip 1pt \noindent Richardson, S., Rimm, E. B., Cohen, J. F.W., Gortmaker, S. L., \textbf{Lee, M. M.} Daily Saturated Fat and Sodium Content of Elementary School Meals in a large sample of 128 geographically diverse school systems in the United States. \textit{Under Review} (2021).
% \end{enumerate}
